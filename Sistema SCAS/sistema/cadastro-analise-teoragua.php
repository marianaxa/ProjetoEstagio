...
<br>
			...
			<div class="row" style="padding-top: 10px">
				...
				<div class="form-group col-sm-1">
					<a href="lista-teoragua.php?idamostra=<?php echo $idamostra ?>"><button type="button" class="btn btn-primary" style=" min-width: 200px"><span class="fa fa-reply"></span> Voltar</button></a>
				</div>
