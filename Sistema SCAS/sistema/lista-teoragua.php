...
<div class="container">
	<fieldset> 
		<legend align="center" style="width:70%;"><h3>Determinação do Grau de Umidade</h3></legend>
		<br>
		...
		<div  class="row">
			...
			<div class="form-group col-sm-2 ">
					...
					<input type="text" class="form-control" name="pesoamostraumidade" id="pesoamostraumidade"  value="<?php echo $pesoamostra?>"  maxlength="5"   readonly="">
				</div>
	...
	-->
		...
		<div class="row">
			...
			<div class="form-group col-sm-8">
				...
				<input type="text" class="form-control" name="umidademedia" id="umidademedia" value="<?php echo $umidademedia?>" readonly="">
			</div>
			<div class="col-sm-2"></div>
		</div>		
		...
		<div class="row">
			...
			<div class="form-group col-sm-8">
				...
				<textarea  class="form-control" rows="3" name="obsteoragua" id="obsteoragua" readonly=""><?php echo $obs?></textarea>
			</div>
			<div class="col-sm-2"></div>
		</div>
