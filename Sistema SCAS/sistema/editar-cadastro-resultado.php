		...
		<form name="formCardastroResultado" id="formCardastroResultado" method="POST" action="crud-amostra">
				...
				<div class="col-sm-8 ">
					<table class="table table-hover" >
						<thead>
							...
							<th scope="col">Velocidade Germinação</th>
							<th scope="col">Plântulas Normais (%)</th>
							<th scope="col">Plântulas Anormais (%)</th>
							<th scope="col">Sementes Duras (%)</th>
							<th scope="col">Sementes Dormentes(%)</th>
							<th scope="col">Sementes Mortas (%)</th>
						...
						<tr class="linhas">
							...
							<td><input type="text" class="form-control" name="descrepeticao[]" id="descrepeticao"></td>
							<td><input type="text" class="form-control" name="pgerminacao[]" id="pgerminacao"></td>
							<td><input type="text" class="form-control" name="velogerminacao[]" id="velogerminacao"></td>
							<td><input type="text" class="form-control" name="pnormais[]" id="pnormais"></td>
							<td><input type="text" class="form-control" name="panormais[]" id="panormais"></td>
							<td><input type="text" class="form-control" name="semduras[]" id="semduras"></td>
							<td><input type="text" class="form-control" name="semdormentes[]" id="semdormentes"></td>
							<td><input type="text" class="form-control" name="semmortas[]" id="semmortas"></td>
			...
			<div class="row" style="padding-top: 10px">
				...
				<div class="form-group col-sm-1">
					<a href="editar-germinacao.php?idamostra=<?php echo $idamostra ?>"><button type="button" class="btn btn-primary" style=" min-width: 200px"><span class="fa fa-reply"></span> Voltar</button></a>
				</div>
