...
$tbrepeticao->select("SELECT ndias_semeadura as 'dias', data, 
...
<br>
		...
		<div class="row">
			<div class="form-group col-sm-12">
				...
				<textarea  class="form-control" rows="3" name="obsgerminacao" id="obsgerminacao" readonly=""><?php echo $obsgerminacao?></textarea>
			</div>
		</div>
