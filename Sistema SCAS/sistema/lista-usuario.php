...
$usuario->select("SELECT id, nome, email, nome_cat_usuario FROM usuarios, categoria_usuario where categoriaUsuarioFK=idcat_usuario");
...
<div class="container">
<fieldset>
	<legend><h3>Lista de Usuários</h3></legend>
		...
		<thead>
			...
			<tbody>
				...
				if ($usuario->numRows() > 0) {
					...
					<tr>
						<th name="id"><?php echo $usuario['id']; ?></th>
						...
						<td><?php echo $usuario['email']; ?></th>
							...
							<td>
								...
								<button id="<?php echo $usuario['id'];?>" nome-user="<?php echo $usuario['nome']; ?>" class="btn btn-danger btn-modal" data-toggle="modal" data-target="#modalExclusao">Excluir</button>
							</td>
						</tr>
						<?php }
					} 
