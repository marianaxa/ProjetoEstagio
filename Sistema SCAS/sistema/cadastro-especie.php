...
<div style="padding: 30px">
  <fieldset style="padding: 10px">
    <legend align="center" style="width:70%;">Cadastro de Espécie</legend>
    <form  name="formCardastroEspecie" id="formCardastroEspecie" method="POST" action="crud-especie.php">
      ...
      <div class="row">
        ...
        <div class="form-group col-sm-4">
          ...
          <input type="number"  class="form-control" name="numRepeticoes" id="numRepeticoes" min="1" placeholder="Ex.: 4" required="">
        </div>
        <div class="form-group col-sm-4">
          <label for="numRepeticoes">Quantidade de Repetições: </label>
          <input type="number"  class="form-control" name="qtdRepeticoes" id="qtdRepeticoes" min="1"  placeholder="Ex.:50" required="">
        </div>
        <div class="form-group col-sm-2"></div> 
      </div>
