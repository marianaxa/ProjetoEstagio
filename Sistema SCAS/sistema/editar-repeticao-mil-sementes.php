		...
		<form name="formCardastroRepeticao" id="formCardastroRepeticao" method="POST" action="crud-amostra">
			...
			<div class="row" style="padding-top: 10px">
				...
				<div class="form-group col-sm-1">
					<a href="editar-pesomilsementes.php?idamostra=<?php echo $idamostra ?>"><button type="button" class="btn btn-primary" style=" min-width: 200px"><span class="fa fa-reply"></span> Voltar</button></a>
				</div>
				<div class="form-group col-sm-1"></div>
				<div class="form-group col-sm-1">
					<button type="submit" name="acao" value="editRepeticaoPMS" class="btn btn-primary" style=" min-width: 200px">Confirmar</button>
				</div>
				<div class="form-group col-sm-4"></div>
			</div>
