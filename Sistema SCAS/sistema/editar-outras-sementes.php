...
<div style="padding: 30px">
	<fieldset  style="padding: 10px">
		<legend align="center" style="width:70%;"><h3> Editar Outras Sementes</h3></legend>

		<form name="formEditarOutrasSementes" id="formEditarOutrasSementes" method="POST" action="crud-amostra">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-3 ">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="peamostra" id="peamostra"  value="<?php echo $peamostra?>">
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-4 ">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="outrasespecies" id="outrasespecies"  value="<?php echo $outrasespecies?>" >
					</div>
				</div>
				<div class="col-sm-4 ">
					<div class="form-group">
						<label for="sementessilvestres">Sementes Silvestres (g):</label> 
						<input type="text" class="form-control" name="sementessilvestres" id="sementessilvestres" value="<?php echo $semsilvestres?>" >
					</div>
				</div>	
				<div class="col-sm-2 "></div>
			</div>
			<div class="row">
				...
				<div class="col-sm-4 ">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="sementestoleradas" id="sementestoleradas" value="<?php echo $semtoleradas?>">
					</div>
				</div>
				<div class="col-sm-4 ">
					<div class="form-group">
						<label for="sementesproibidas">Sementes Proibidas (g):</label> 
						<input type="text" class="form-control" name="sementesproibidas" id="sementesproibidas" value="<?php echo $semproibidas?>">
					</div>
				</div>	
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="row">
				...
				<div class="form-group col-sm-8">
					...
					<textarea  class="form-control" rows="3" name="obsoutrassem" id="obsoutrassem"><?php echo $obsoutrassem?></textarea>
				</div>
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="row" style="padding: 10px">
				...
				<div class="form-group col-sm-1">
					<button type="submit" name="acao" value="editOutrasSementes" class="btn btn-success" style=" min-width: 200px">Confirmar</button>
				</div>
