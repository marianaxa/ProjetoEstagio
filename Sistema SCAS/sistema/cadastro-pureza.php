	...
	<fieldset  style="padding: 10px">
		...
		<form name="formCardastroPureza" id="formCardastroPureza" method="POST" action="crud-amostra">
			...
			<div class="row">
				...
				<div class="col-sm-3 ">
					<div class="form-group">
						<label for="naturezamatinerte">Natureza do Material inerte:</label> 
						<input type="text" class="form-control" name="naturezamatinerte" id="naturezamatinerte" >
					</div>
				</div>
				<div class="col-sm-3 ">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="form-group col-sm-8">
					...
					<textarea  class="form-control" rows="3" name="obspureza" id="obspureza"></textarea>
				</div>
				<div class="col-sm-2"></div>
			</div>
...
<!-- 					<div class="form-group col-sm-1">
 				...
 				-->
 				<div class="form-group col-sm-1">
 					<button type="submit" name="acao" value="createPureza" class="btn btn-success" style=" min-width: 200px">Confirmar</button>
 				</div>
 				<div class="form-group col-sm-4"></div>
 			</div>
