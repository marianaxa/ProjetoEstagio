						...
						<div class="col-sm-5"> 
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" id="idradio" name="idradio" maxlength="30" minlength="1" placeholder="Pesquisar..." required="true" readonly="">
					...
					<fieldset>		
						...
						<div class="row">
							...
							<div class="form-group col-sm-4">
								...
								<input type="number" class="form-control" name="alturaComercial" id="alturaTotal" min="1" >
							</div>
						</div>
