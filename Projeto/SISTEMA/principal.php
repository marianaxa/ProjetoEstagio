...
<header>
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="lista-lote.php">Lotes
								...
								<ul class="dropdown-menu">
									...
									<li><a href="lista-lote-recebido.php">Lista de Lotes</a></li>
	...
	<div id="interface">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<a href="lista-lote.php"><button class="btn btn-primary btn-sm" style="font-size:24px"><i class="fa fa-list"></i><p>Lista de Lotes</p></button></a>
			</div>
			<div class="col-sm-4">
