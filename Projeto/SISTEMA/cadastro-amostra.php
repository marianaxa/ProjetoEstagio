						...
						<div class="row">
							<div class="col-sm-4 ">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" class="form-control" name="idradiolote" id="idradiolote" maxlength="5" minlength="1" placeholder="Pesquisar... " required="" readonly="">
							...
							<div class="row">
								...
								<div class="form-group col-sm-2">
									...
									<input type="text"  class="form-control"  name="nome-especie" id="nome-especie" maxlength="30" minlength="1" placeholder="Ex.: Pupunha" required="" readonly="">
								</div>
								<div class="form-group col-sm-2">							
									<label for="nomeCientifico">Nome Científico:</label>
									<input type="text"  class="form-control"  name="nomeCientifico"  maxlength="30" minlength="1" id="nomeCientifico" placeholder="Ex.: Bactris gasipaes" required="" readonly="">
								</div>
								<div class="form-group col-sm-2">	
