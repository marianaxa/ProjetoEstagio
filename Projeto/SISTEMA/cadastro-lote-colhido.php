					...
					<tbody>
						...
						if ($arvores->numRows() > 0) {
							...
							<tr>
								...
								<td><?php echo $arvores['tipo_colheita']; ?></td>
								<td><?php echo $arvores['localizacao']; ?></td>
								<td><?php echo $arvores['tipo_solo']; ?></td>
								<td><?php echo $arvores['tipo_vegetacao']; ?></td>
								<td><?php echo $arvores['tipo_terreno']; ?></td>
								<td>
...
<div class="row">
	<div class="form-group col-sm-4">							
		...
		<input type="number" class="form-control" name="alturaTotal" id="alturaTotal" min="1" >
	</div>
	<div class="form-group col-sm-4">
		<label for="alturaComercial">Altura Comercial:</label>
		<input type="number" class="form-control" name="alturaComercial" id="alturaComercial" min="1" >
	</div>
	<div class="form-group col-sm-4">
		<label>DAP:</label>
