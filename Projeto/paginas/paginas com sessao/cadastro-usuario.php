				...
				<form name="formCardastroUsuario" id="formCardastroUsuario" method="get" action="#">
					...
					<div class="row">
						...
						<div  class="form-group col-sm-2">
							...
							<select class="form-control" for="cargo" required="">
					...
					<div class="row">
						<div  class="form-group col-sm-4">
							...
							<input type="password" class="form-control" name="senha" id="senha" maxlength="10" minlength="1" placeholder="********" required="">
						</div>

						<div  class="form-group col-sm-4">
							<label for="senhaConfirmacao">Confimar Senha:</label>
							<input type="password" class="form-control" name="senhaConfirmacao" id="senhaConfirmacao" maxlength="10" minlength="1"  placeholder="********" required="">
						</div>
					</div>
