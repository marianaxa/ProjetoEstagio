				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<section>
						<fieldset>
							...
							<form name="formCadastroTesteGerminacao" id="formCadastroTesteGerminacao" method="get" action="#">
								<!-- Detalhes da Amostra -->
								<div class="form-row">
									<div class="form-group col-md-12">
										<a href="">Detalhes da Amostra</a>
									</div>
								</div>
								<!-- Primeira Linha -->
								<div class="form-row">
								...
								<div class="form-row">
									<div class="form-group col-md-3 col-md-offset-2">
										<label for="temperatura">Temperatura (º):</label>
								...
								<div class="form-row">
									<div class="form-group col-md-3 col-md-offset-2">
										...
										<input type="text" class="form-control" name="substrato" id="substrato" required="">
									</div>
								</div>
								<!-- Fim Segunda Linha -->
								<!--Terceira Linha -->
