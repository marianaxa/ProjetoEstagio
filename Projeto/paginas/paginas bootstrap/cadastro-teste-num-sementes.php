      ...
      <fieldset>
        ...
        <form  name="formCardastroNumSementes" id="formCardastroNumSementes" method="get" action="#">
          ...
          <div class="form-group col-md-10">
            ...
            <input type="text" class="form-control" name="pesoAmostra" id="pesoAmostra" maxlength="4" minlength="1" placeholder="Ex.: 10" required="">
          </div>

          <div class="form-group col-md-10">
          <label for="numSementesKh"> N° Sementes (KH): </label>
          <input type="text" class="form-control" name="numSementesKh" id="numSementesKh" maxlength="4" minlength="1" placeholder="Ex.: 10" required="">
          </div>
