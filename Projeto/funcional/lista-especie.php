          ...
          <div class="col-sm-4">
           <div class="form-group">
             <div class="input-group">
              <input type="text" class="form-control" id="myInput" onkeyup="BuscaLista()" placeholder="Pesquisar por espécie...">
                ...
                if ($especie->numRows() > 0) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-danger" data-toggle="modal" data-target="#modalExclusao">Excluir</button>
                    </td>
                  </tr>
                  <?php }
                } 
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
          <!-- mensagem -->
          <h4>Deseja realmente excluir a espécie <?php echo $especie['nome_vulgar']; ?> ?</h4>
          <br>
          <button type="button" class="btn btn-default" data-dismiss="modal">NÃO</button>  
          <a href="crud-especie.php?id=<?php echo $especie['id_especie']; ?>&acao=delete">

            <button name="acao" value="delete" class="btn btn" >SIM</button>
          </a>
        </div>
      </div>
    </div>
